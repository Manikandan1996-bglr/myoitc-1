...
public class HistoryDetails extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        supportMapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                if (!historyData.getCheckinLat().equals("null") && !historyData.getCheckinLang().equals("null") && !historyData.getCheckoutLan().equals("null") && !historyData.getCheckoutLang().equals("null")) {
                    ...
                    googleDirectionsUrl.append("origin=").append(historyData.getCheckinLat()).append(",").append(historyData.getCheckinLang());
                    googleDirectionsUrl.append("&destination=").append(historyData.getCheckoutLan()).append(",").append(historyData.getCheckoutLang());
                    googleDirectionsUrl.append("&key=").append(getResources().getString(R.string.google_key));
        ...
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd hh:mm:ss", Locale.US);//set format of date you receiving from db
